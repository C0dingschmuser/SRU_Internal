...
bool ImGui::SliderByte(const char* label, uint8_t* v, uint8_t v_min, uint8_t v_max, const char* format, ImGuiSliderFlags flags)
{
...
bool ImGui::InputUInt16(const char* label, uint16_t* v, uint16_t step, uint16_t step_fast, ImGuiInputTextFlags flags)
{
