...
namespace ImGui
{
    ...
    IMGUI_API bool          SliderByte(const char* label, uint8_t* v, uint8_t v_min, uint8_t v_max, const char* format = "%d", ImGuiSliderFlags flags = 0);
    ...
    IMGUI_API bool          InputUInt16(const char* label, uint16_t* v, uint16_t step = 1, uint16_t step_fast = 100, ImGuiInputTextFlags flags = 0);
